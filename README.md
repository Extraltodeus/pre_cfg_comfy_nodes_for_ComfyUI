...
The node named "Pre CFG gradient scaling" can do some similar stuff to controlnet without inferences. I'll share better settings than this but so you can see:
